drop program jw2_mpage_documents_json:dba go
create program jw2_mpage_documents_json:dba
...
with outdev, personid, encntrid, lkbRange
...
declare MDOCCd  = f8 with public,constant(uar_get_code_by("MEANING", 53, "MDOC"))
...
plan ce
	...
	and ce.event_end_dt_tm >= cnvtlookbehind($lkbRange,cnvtdatetime(curdate,curtime3))
	and ce.valid_until_dt_tm > cnvtdatetime(curdate,curtime3)
	and ce.encntr_id = $encntrid
	and ce.result_status_cd != inErrorCd
	and ce.event_class_cd in (DOCCd,MDOCCd)
join ceb
