...
head report
   ...
   sXML = concat(sXML, "<patientInfo_detail>This person's name is: ",trim(p.name_full_formatted),"</patientInfo_detail>")
   sXML = concat(sXML, "</patientInfo>")
   ...
   sXML = concat(sXML, "<patientInfo_detail>This person's birthdate is: ",trim(dob),"</patientInfo_detail>")
   sXML = concat(sXML, "</patientInfo>")
   ...
   sXML = concat(sXML, "<patientInfo_detail>This person's gender is: ",trim(gender),"</patientInfo_detail>")
   sXML = concat(sXML, "</patientInfo>")
with nocounter
